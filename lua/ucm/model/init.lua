...
M["get-term"] = function(name, hash, relative_to)
  utils.notify({name = name, hash = hash, ["relative-to"] = relative_to})
...
M["get-type"] = function(name, hash, relative_to)
  ...
  local function _1_(key)
    _G.assert((nil ~= key), "Missing argument key on /Users/chuwy/workspace/ucm.nvim/fnl/ucm/model/init.fnl:15")
