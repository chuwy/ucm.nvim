...
local _local_1_ = require("ucm.nvim.nfnl.module")
local autoload = _local_1_["autoload"]
local core = autoload("ucm.nvim.nfnl.core")
local fs = autoload("ucm.nvim.nfnl.fs")
local fennel = autoload("ucm.nvim.nfnl.fennel")
local notify = autoload("ucm.nvim.nfnl.notify")
local config = autoload("ucm.nvim.nfnl.config")
local mod = {}
